  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        // Black hole gradient
        'black-hole':
          'radial-gradient(ellipse at center, #000000 0%, #0D0B14 40%, #1A1625 70%, #05050A 100%)',
        // Event horizon glow
      ...
      boxShadow: {
        ...
        'panel-hover':
          '0 8px 30px rgba(96, 165, 250, 0.1), 0 0 0 1px rgba(96, 165, 250, 0.3)',
        horizon:
          '0 0 20px #60A5FA, 0 0 40px rgba(168, 85, 247, 0.5), 0 0 60px rgba(96, 165, 250, 0.4)',
        'horizon-sm': '0 0 10px #60A5FA, 0 0 20px rgba(168, 85, 247, 0.3)',
        'horizon-lg':
          '0 0 30px #60A5FA, 0 0 60px #A855F7, 0 0 90px rgba(96, 165, 250, 0.6)',
      ...
      keyframes: {
        ...
        horizonPulse: {
          '0%, 100%': {
            boxShadow: '0 0 20px #60A5FA, 0 0 40px rgba(168, 85, 247, 0.5)',
          },
          '50%': {
            boxShadow:
              '0 0 30px #60A5FA, 0 0 60px #A855F7, 0 0 80px rgba(96, 165, 250, 0.6)',
          },
        },
        orbit: {
